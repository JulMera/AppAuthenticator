...
@Component({
  selector: 'page-tk-qr',
  templateUrl: 'tk-qr.html',
})
export class TkQrPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private storage: Storage, public utils: UtilsProvider, public platform: Platform,
    public http: HttpProvider, public menuCtrl: MenuController, private alertCtrl: AlertController, public push: Push) {
          ...
          if (val != null) {
            ...
            this.http.callServer(this.jsonDataDevice, urlOtp).then(res => {
              ...
              if (res.messageId != null || res.messageId != "") {
                ...
                this.msgjsessionId = res.msgjsessionId;
              }
              ...
              try {
                ...
                if (res.message.code == "0000") {
                  ...
                  this.utils.presentAlert(res.description);
                  this.isBtnEnabled = false;
                }
